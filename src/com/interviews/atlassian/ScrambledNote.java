 ...
 *
 * <p>Your task is to write a function that, given a list of words and a note, finds and returns the
 * word in the list that is scrambled inside the note, if any exists. If none exist, it returns the
 * result {@code "-"} as a string.</p>
 *
 * <p>There will be at most one matching word. The letters do not need to be in order or next to each
 * other. The letters cannot be reused.</p>
 *
 * <h2>Example</h2>
 * <pre>
 ...
 * <ul>
 *     <li>{@code W} = number of words in {@code words}</li>
 *     <li>{@code S} = maximal length of each word or of the note</li>
 * </ul>
 */
